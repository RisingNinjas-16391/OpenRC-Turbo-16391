...
public class AutoCommandMultiCone extends SequentialCommandGroup {
    ElapsedTime timer = new ElapsedTime();

    public AutoCommandMultiCone(DrivetrainSubsystem drivetrain, LiftSubsystem lift, IntakeSubsystem intake, AprilTagSubsystem aprilTagDetector, Telemetry telemetry) {
        ...
        TrajectorySequenceSupplier coneToHigh = () -> drivetrain.trajectorySequenceBuilder(drivetrain.getPoseEstimate()).setTangent(90)
                ...
                .splineToSplineHeading(new Pose2d(-28, -5, Math.toRadians(45)), Math.toRadians(40)).setTangent(Math.toRadians(230))
                .build();
        ...
        addCommands(
                ...
                new ParallelDeadlineGroup(
                        new FollowTrajectoryCommand(drivetrain, initToCone),
                ...
                new ParallelDeadlineGroup(
                        new FollowTrajectoryCommand(drivetrain, highToCone),
                        new LiftCommand(lift, LiftConstants.LOW_POS)
                ),
                new LiftCommand(lift, 5), //TODO: set to height of auto cones
                new LiftCommand(lift, LiftConstants.LOW_POS),
