...
public class AutoCommandMultiCone extends SequentialCommandGroup {
    ...
    public AutoCommandMultiCone(DrivetrainSubsystem drivetrain, LiftSubsystem lift, IntakeSubsystem intake, AprilTagSubsystem aprilTagDetector, boolean right) {
        ...
        Command highToStack = new SequentialCommandGroup(
                new ParallelCommandGroup(
                        new FollowTrajectoryCommand(drivetrain, AutoTrajectories.highToStackTrajectory(drivetrain, right)),
                        new SequentialCommandGroup(
