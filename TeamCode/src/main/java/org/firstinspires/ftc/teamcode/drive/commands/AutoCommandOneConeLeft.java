...
public class AutoCommandOneConeLeft extends SequentialCommandGroup {
    ElapsedTime timer = new ElapsedTime();

    public AutoCommandOneConeLeft(DrivetrainSubsystem drivetrain, LiftSubsystem lift, IntakeSubsystem intake, AprilTagSubsystem aprilTagDetector, Telemetry telemetry) {
