...
public class AutoCommandMultiConeLeft extends SequentialCommandGroup {
    ElapsedTime timer = new ElapsedTime();

    public AutoCommandMultiConeLeft(DrivetrainSubsystem drivetrain, LiftSubsystem lift, IntakeSubsystem intake, AprilTagSubsystem aprilTagDetector, Telemetry telemetry) {
        ...
        TrajectorySequenceSupplier highToStackTrajectory = () -> drivetrain.trajectorySequenceBuilder(new Pose2d(-28, -5, Math.toRadians(225)))
        ...
        TrajectorySequenceSupplier highToParkTrajectory = () -> drivetrain.trajectorySequenceBuilder(new Pose2d(-28, -5, Math.toRadians(240)))
