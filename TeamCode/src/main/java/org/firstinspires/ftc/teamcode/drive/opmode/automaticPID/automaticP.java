...
public class automaticP extends LinearOpMode {
    public static double DISTANCE = 72; // in
    public double currentError = 0;
    public double previousError = 0;
    public double changeInP = DriveConstants.changeInP;
    ...
    public PIDFCoefficients temp_MOTOR_VELO_PID = new PIDFCoefficients(0, MOTOR_VELO_PID.i, MOTOR_VELO_PID.d, MOTOR_VELO_PID.f);
