...
public class AutoCommandOneConeV2 extends SequentialCommandGroup {
    ElapsedTime timer = new ElapsedTime();

    public AutoCommandOneConeV2(DrivetrainSubsystem drivetrain, LiftSubsystem lift, IntakeSubsystem intake, AprilTagSubsystem aprilTagDetector, Telemetry telemetry) {
